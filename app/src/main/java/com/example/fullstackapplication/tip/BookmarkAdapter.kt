...
class BookmarkAdapter(var context:Context, var data: ArrayList<ListVO>,var keyData :ArrayList<String>,var bookmarkList: ArrayList<String>)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(bookmarkList.contains(keyData[position])){
            ...
            Glide.with(context).load(data[position].imgId).into(holder.imgContent)//홀더에 있는 이미지 컨텐트에 적용하겟다
